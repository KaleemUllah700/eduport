                ...
                <div className="flex flex-col gap-4">
                    ...
                    <form className="flex flex-col gap-4">
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="text" name="fullname" className="bg-slate-200 p-4 rounded focus:outline-0" />
                        </div>

                        <div className="flex flex-col gap-2">
                            <label>Email*</label>
                            <input type="email" name="email" className="bg-slate-200 p-4 rounded focus:outline-0" />
                        </div>

                        <div className="flex flex-col gap-2">
                            <label>Message*</label>
                            <textarea name="message" className="bg-slate-200 p-4 rounded focus:outline-0" rows={4} />
                        </div>
